 ...
 * 폰은 트랙 옆에 두고 쓰는데 7초 만에 작아지면, 주우러 갔다 오는 사이에 사라진다.
 * 다만 다음 자동차를 쫓는 동안에는 화면을 가리지 않도록 구석으로 물러난다.
 */
const BANNER_HINT_MS = 6000;    // 안내 문구만 잠깐 띄운다
